...
const cometInstance = "usdc-sepolia";
...
const connections = {
  ...
  "usdc-sepolia": {
    ...
    blockNumber: 6408386, // 2023-10-20T16:23:02.000Z
    chainId: 137,
  },
};
...
const mnemonic =
  "romance zebra roof insect stem water kiwi park acquire domain gossip second";

if (!providerUrl) {
  console.error(
    "Missing JSON RPC provider URL as environment variable. See hardhat.config.js."
  );
  process.exit(1);
}
